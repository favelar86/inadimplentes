...
import com.ada.inadimplentes.exceptions.StandardError;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ClienteNaoEncontradoException.class, UsuarioNaoEncontradoException.class, UsernameNotFoundException.class})
